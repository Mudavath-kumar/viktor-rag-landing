  ...
  head: () => ({
    meta: [
      { title: "Viktor RAG — Multi-Modal Agentic RAG Platform" },
      {
        name: "description",
        content:
          "Upload PDFs, images, code, and spreadsheets. Verified answers with source citations powered by agentic retrieval.",
      },
      { property: "og:title", content: "Viktor RAG — Multi-Modal Agentic RAG Platform" },
      {
        property: "og:description",
        content:
          "Verified, cited answers from your documents — powered by LangGraph agents and hybrid retrieval.",
      },
    ],
  }),
  component: Index,
...
function Reveal({
  ...
  return (
    <div
      ref={ref}
      className={`${isVisible ? ANIM_CLASS[variant] : "opacity-0"} ${className}`}
        ...
        <div className="lg:col-span-6">
          ...
          <Reveal delay={0.15}>
            <h1 className="mt-5 text-[44px] md:text-[68px] lg:text-[80px] leading-[0.95] tracking-tight text-[#051A24]">
              Understand <span className="font-mondwest text-[#1f5d4f]">your</span>
              <br />
              documents.
              <br />
          ...
          <Reveal delay={0.3}>
            <p className="mt-8 text-[17px] leading-relaxed text-[#273C46] max-w-[520px]">
              Viktor is an agentic retrieval platform. Drop in PDFs, images, code, and spreadsheets
              — get answers grounded in the exact page, chunk, and line they came from.
            </p>
          </Reveal>
          <Reveal delay={0.4}>
            <div className="mt-10 flex flex-wrap gap-3">
              <Link to="/upload">
                <PrimaryBtn>Upload a document</PrimaryBtn>
              </Link>
              <Link to="/chat">
                <SecondaryBtn>Try the chat</SecondaryBtn>
              </Link>
            </div>
          </Reveal>
          <Reveal delay={0.5}>
            <dl className="mt-12 grid grid-cols-3 gap-6 max-w-md border-t border-[#051A24]/10 pt-6">
              <div>
                <dt className="text-xs text-[#273C46]">Hallucination</dt>
                <dd className="font-mondwest text-3xl text-[#051A24]">-94%</dd>
              </div>
              <div>
                <dt className="text-xs text-[#273C46]">Retrieval P95</dt>
                <dd className="font-mondwest text-3xl text-[#051A24]">340ms</dd>
              </div>
              <div>
                <dt className="text-xs text-[#273C46]">Cited answers</dt>
                <dd className="font-mondwest text-3xl text-[#051A24]">100%</dd>
              </div>
            </dl>
          </Reveal>
        </div>
        <div className="lg:col-span-6 relative">
          <Reveal delay={0.2}>
            <div className="relative">
              ...
              <img
                src={heroBook}
                alt="An open book with translucent pages and highlighted passages"
                className="relative w-full rounded-[28px] shadow-[0_30px_80px_-30px_rgba(5,26,36,0.4)] object-cover aspect-[5/6]"
              />
              <div className="absolute -bottom-6 -right-4 md:-right-10 bg-white rounded-2xl shadow-xl p-5 w-[260px]">
                <div className="flex items-center gap-2 text-xs font-mono text-[#1f5d4f]">
                  <ShieldCheck className="w-4 h-4" />
                  VERIFIED · 0.97
                </div>
                <p className="mt-2 text-sm leading-snug text-[#051A24]">
                  "The clause appears on page 14, paragraph 3, and matches the cited precedent."
                </p>
...
const caps = [
  {
    Icon: FileText,
    title: "PDF & DOCX",
    desc: "Layout-aware extraction with tables and footnotes preserved.",
  },
  {
    Icon: ImageIcon,
    title: "Images & Scans",
    desc: "PaddleOCR pipeline for handwriting, diagrams, and screenshots.",
  },
  {
    Icon: Code,
    title: "Code Repos",
    desc: "Tree-sitter parsing for dependency and architecture maps.",
  },
  {
    Icon: Table,
    title: "Spreadsheets",
    desc: "Semantic table understanding across sheets and merged cells.",
  },
];
    ...
    <section className="py-20 px-6 max-w-3xl mx-auto text-center">
      ...
      <Reveal delay={0.1}>
        <p className="text-[32px] md:text-[44px] leading-[1.1] tracking-tight text-[#0D212C]">
          "We reduced research time by 80% using{" "}
          <span className="font-mondwest text-[#1f5d4f]">Viktor's</span> agentic verification."
        </p>
      </Reveal>
      <Reveal delay={0.2}>
        <p className="italic text-sm text-[#273C46] mt-6">
          Dr. Sarah Chen · Research Lead, BioTech Labs
        </p>
      </Reveal>
      <Reveal delay={0.3}>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
          <Reveal delay={0.1}>
            <div className="bg-[#051A24] rounded-[32px] p-10 h-full">
              ...
              <h3 className="text-[22px] font-medium text-[#F6FCFF] mt-2">
                For individual researchers
              </h3>
              <p className="mt-6">
                <span className="text-5xl font-mondwest text-[#F6FCFF]">$49</span>
                <span className="text-sm text-[#E0EBF0]">/month</span>
              </p>
              <ul className="mt-8 space-y-3 text-sm text-[#E0EBF0]">
                {[
                  ...
                  <li key={f} className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-[#5cc9b1]" />
                    {f}
                  </li>
                ))}
              </ul>
              <div className="mt-10">
                <InvertedBtn>Start free trial</InvertedBtn>
              </div>
            </div>
          </Reveal>
          <Reveal delay={0.2}>
            <div className="bg-white border border-[#051A24]/10 rounded-[32px] p-10 h-full">
              ...
              <h3 className="text-[22px] font-medium text-[#051A24] mt-2">
                For teams that need verification
              </h3>
              <p className="mt-6">
                <span className="text-5xl font-mondwest text-[#0D212C]">Custom</span>
              </p>
              <ul className="mt-8 space-y-3 text-sm text-[#051A24]">
                {[
                  "Unlimited queries",
                  "ZIP repos & code analysis",
              ...
              <div className="mt-10">
                <PrimaryBtn>Contact sales</PrimaryBtn>
              </div>
            </div>
          </Reveal>
        </div>
...
const features = [
  {
    ...
    desc: "Classifies intent and chooses retrieval strategy.",
  },
  { Icon: Search, title: "Hybrid Retrieval", desc: "Vector + BM25 with reciprocal rank fusion." },
  {
    Icon: ShieldCheck,
    title: "Claim Verification",
    desc: "Detects unsupported claims in real time.",
  },
  { Icon: Quote, title: "Source Citations", desc: "Maps every answer to file, page, and chunk." },
  {
    Icon: Sparkles,
    title: "Response Generation",
    desc: "Synthesizes verified information into prose.",
  },
  {
    Icon: TrendingUp,
    title: "Confidence Score",
    desc: "0–100 score from similarity + verification.",
  },
];
...
const testimonials = [
  {
    quote: "The verification agent caught hallucinations our previous RAG system missed entirely.",
    name: "Marcus Anderson",
    role: "CTO, DataFlow",
  },
  {
    quote: "Source citations alone saved our support team 20 hours a week.",
    name: "Alex Wu",
    role: "Founder, Nexgate",
  },
  {
    quote:
      "Hybrid retrieval found chunks pure vector search missed. The BM25 fusion is genuinely better.",
    name: "James Mitchell",
    role: "VP Eng, LaunchPad",
  },
  {
    quote: "It understood our architecture better than our own docs.",
    name: "Rachel Foster",
    role: "Co-founder, Nexus Labs",
  },
  {
    quote: "From PDFs to ZIP repos, it handles everything we throw at it.",
    name: "David Zhang",
    role: "Head of AI, Paradigm",
  },
];
    ...
    >
      ...
      <div className="max-w-[1100px] mx-auto px-6">
        <div className="bg-[#f0f0ee] rounded-[32px] p-10 md:p-14 min-h-[260px]">
          ...
          <p className="mt-6 text-[22px] md:text-[28px] leading-[1.3] text-[#0D212C]">
          ...
          <div className="mt-8 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="w-10 h-10 rounded-full border border-[#0D212C]/20 flex items-center justify-center hover:bg-[#051A24] hover:text-white transition-all"
                aria-label="Previous"
              >
  ...
  return (
    <section className="py-20 md:py-28 px-6">
      <div className="max-w-[1200px] mx-auto bg-[#051A24] rounded-[40px] py-20 md:py-32 px-8 text-center relative overflow-hidden">
        ...
        <div className="relative">
          <h2 className="font-mondwest text-[48px] md:text-[80px] text-white leading-[1.05]">
            Ready to ground your AI?
          </h2>
          <div className="mt-10 flex flex-wrap gap-3 justify-center">
            <Link to="/upload">
              <InvertedBtn>Upload a document</InvertedBtn>
            </Link>
            <Link to="/dashboard">
              <button className="bg-transparent border border-white/30 text-white rounded-full px-7 py-3 text-[13px] font-medium hover:bg-white/10 transition-all inline-flex items-center gap-2">
...
function LogoMarquee() {
  ...
  return (
    <section className="py-10 border-y border-[#051A24]/10 bg-[#f0f0ee] overflow-hidden">
      <p className="text-center text-xs font-mono uppercase tracking-[0.18em] text-[#273C46] mb-6">
        Trusted by research & engineering teams
      </p>
      <div className="relative">
        <div className="flex gap-16 animate-marquee whitespace-nowrap">
          {[...logos, ...logos].map((l, i) => (
            <span
              key={i}
              className="text-2xl font-medium text-[#051A24]/70 hover:text-[#051A24] transition-colors"
            >
              {l}
            </span>
          ))}
  ...
  const steps = [
    {
      ...
      desc: "PDFs, scans, ZIP repos, spreadsheets — Viktor parses layout, OCR, and structure in one pass.",
    },
    {
      Icon: Cpu,
      kicker: "02 · Reason",
      title: "Agents do the work",
      desc: "Query planning, hybrid retrieval, cross-encoder re-ranking, and claim verification — all observable.",
    },
    {
      Icon: ShieldCheck,
      kicker: "03 · Trust",
      title: "Get cited answers",
      desc: "Every sentence links back to the exact page, cell, or line. Confidence scored, never guessed.",
    },
  ];
  return (
          ...
          {steps.map((s, i) => (
            <Reveal key={s.title} delay={0.12 * i} variant="up">
              <div className="relative bg-[#f7f7f5] rounded-3xl p-8 h-full border border-[#051A24]/5 smooth-hover hover:-translate-y-1 hover:shadow-[0_30px_60px_-30px_rgba(5,26,36,0.18)]">
                ...
                <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-[#1f5d4f]">
                  {s.kicker}
                </p>
      ...
      <div className="max-w-[1200px] mx-auto grid md:grid-cols-2 gap-10 items-center">
        <Reveal variant="left">
          ...
          <p className="mt-6 text-[#273C46] max-w-md">
            Viktor surfaces every retrieval, every score, every verification step. No black box —
            just trace lines you can audit.
          </p>
          <div className="mt-8 flex gap-3">
            <Link to="/chat">
              <PrimaryBtn className="inline-flex items-center gap-2">
                <PlayCircle className="w-4 h-4" /> Try it now
              </PrimaryBtn>
            </Link>
            <Link to="/docs">
              <SecondaryBtn>How it traces</SecondaryBtn>
            </Link>
          </div>
        </Reveal>
            ...
            <div className="relative bg-[#051A24] rounded-[28px] p-7 text-white shadow-[0_40px_80px_-30px_rgba(5,26,36,0.5)]">
              ...
              <div className="mt-5 text-sm font-mono space-y-2.5 min-h-[210px]">
                {lines.map((l, i) => (
                  <div
                    key={i}
                    className={`flex items-start gap-3 transition-all duration-500 ${i < step ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-2"}`}
                  >
                    <span className="text-[#5cc9b1] mt-0.5">{i < step - 1 ? "✓" : "›"}</span>
                    <span className={`${i === step - 1 ? "text-white" : "text-white/60"}`}>
                      {l}
                    </span>
              ...
              <div className="mt-4 pt-4 border-t border-white/10 grid grid-cols-3 gap-3 text-center">
                <div>
                  <p className="font-mondwest text-2xl text-[#5cc9b1]">8/8</p>
                  <p className="text-[10px] text-white/50 mt-1">verified</p>
                </div>
                <div>
                  <p className="font-mondwest text-2xl">0.94</p>
                  <p className="text-[10px] text-white/50 mt-1">confidence</p>
                </div>
                <div>
                  <p className="font-mondwest text-2xl">340ms</p>
                  <p className="text-[10px] text-white/50 mt-1">latency</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="md:col-span-2">
          <Reveal variant="left">
            ...
            <p className="mt-5 text-[#273C46]">
              Connect the tools your team already uses — Viktor syncs, indexes, and verifies in the
              background.
            </p>
            <Link
              to="/docs"
              className="mt-6 inline-flex items-center gap-1 text-sm text-[#1f5d4f] font-medium"
            >
...
function FAQ() {
  const faqs = [
    [
      "How is Viktor different from a regular RAG wrapper?",
      "Most RAG wrappers retrieve and generate. Viktor adds query planning, hybrid retrieval with re-ranking, claim-level verification, and per-answer confidence scoring — every step is observable.",
    ],
    [
      "What formats do you support?",
      "PDFs, DOCX, scanned images, photos, ZIP code repos, spreadsheets, audio transcripts, and HTML pages. Layout, tables, equations, and figures are preserved.",
    ],
    [
      "Can I use my own LLM?",
      "Yes. We default to GPT-4o-class models and support Claude, Gemini, and open-weight models on Team and Enterprise plans.",
    ],
    [
      "Is my data used to train models?",
      "Never. Your data is yours. Per-workspace isolation, encryption at rest, audit logs on every query.",
    ],
    [
      "How accurate are the citations?",
      "Quote-level alignment between answers and source chunks — citations point to the exact page, paragraph, cell, or line.",
    ],
  ];
  return (
          ...
          <Reveal key={q} delay={0.05 * i}>
            <details className="group py-6 cursor-pointer">
              <summary className="flex justify-between items-center list-none gap-6">
                ...
                <span className="text-2xl text-[#1f5d4f] transition-transform duration-500 group-open:rotate-45 shrink-0">
                  +
                </span>
              </summary>
